...
const Chat = () => {
    ...
    const toolBar = (
        <div className="flex flex-row">
            ...
            <Button icon="pi pi-video" title="Appel vidéo" className="text-white border border-none p-inputgroup-addon bg-transparent outline outline-none" />
    ...
    const handleSendMessage = () => {
        if (inputMsg.trim()) {
            ...
            console.log("Message envoyé:", inputMsg);
            setInputMsg(""); // Réinitialiser le champ de saisie
        }
    };
                        ...
                        >
                            <div className="bg-blackAccent rounded-3xl px-3">
                                <div className="p-inputgroup flex-1">
                                    ...
                                    <Button icon="pi pi-send" className="text-white border border-none p-inputgroup-addon bg-transparent outline outline-none" type="submit" />
                                </div>
                            </div>
                        </motion.form>
                    </>
