        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.8 }}>
            ...
            <main className="flex flex-col justify-center items-center mx-44 mt-2">
                ...
                <form>
                    ...
                    <Button label="Valider" className="flex justify-center items-center mx-auto mt-12 bg-blueSlate text-white border border-none outline outline-none font-poppins text-sm px-6 " />
                </form>
            </main>
        </motion.div>
    )
