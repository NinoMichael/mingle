    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.8 }}>
            ...
            <main className="flex flex-col justify-center items-center mx-44">
                ...
                <Divider className="mt-10 w-96" />
                <p className="mt-4 text-xs">Vous n'avez pas encore reçu de code ? <Link className="text-blueSlate no-underline">Renvoyer le code</Link></p>
            </main>
        </motion.div>
    )
}
