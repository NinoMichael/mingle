...
const Register = () => {
    ...
    const countries = countryTelephoneData.allCountries.map((country) => ({
        ...
        flag: `https://flagcdn.com/${country.iso2.toLowerCase()}.png` // Lien vers le drapeau
    }));
                ...
                <motion.form className="bg-blackAccent px-12 pt-8 pb-12 rounded shadow" variants={fadeInUp} transition={{ delay: 0.5 }}>
                    ...
                    <div className="flex flex-column gap-2">
                        <Dropdown
                            ...
                            valueTemplate={(option) => (
                                <div className="flex align-items-center">
                                    <img src={option.flag} alt={option.name} style={{ width: '20px', marginRight: '10px' }} />
                        ...
                        <InputText
                            ...
                            className="w-full"
                            disabled={!country} // Désactiver si aucun pays sélectionné
                        />
                    </div>
