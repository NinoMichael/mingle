            ...
            <main className="grid grid-cols-2 mx-40 space-x-24 justify-center items-center mt-20">
                <section className="flex flex-col items-center justify-center mx-auto">
                    ...
                    <div className="flex flex-row justify-between space-x-12 mt-6">
                        <Button label="S'inscrire" className="bg-blackAccent font-poppins text-sm border border-none outline outline-none shadow text-white px-6" />
                        <Button label="Se connecter" className="bg-blueSlate font-poppins text-sm border border-none outline outline-none shadow text-white px-6" />
                    </div>
