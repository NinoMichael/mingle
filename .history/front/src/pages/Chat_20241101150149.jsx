    ...
    return (
        <>
            ...
            <motion.div initial="hidden" animate="visible" exit="hidden" transition={{ duration: 0.8 }} className="bg-blackPure w-[75vw] ms-[25vw]">
                ...
                <form className="w-[72vw] absolute bottom-20 h-8 ms-4">
                    <div className="bg-blackAccent rounded-3xl">
                        <div className="p-inputgroup flex-1 ">
                            ...
                            <InputTextarea rows={1} autoResize value={inputMsg} onChange={(e) => setInputMsg(e.target.value)}
                                className="custom-input-search font-poppins h-8 bg-transparent indent-3 border border-none placeholder:text-white text-white text-xs"
