        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.8 }}>
            <div className="flex justify-between mt-8 mx-12">
                ...
                <Dialog
                    modal
                    visible={visible}
                    style={{ width: '50vw', backgroundColor: 'black', color: 'white' }}
                    className="p-6 text-white flex flex-col items-center justify-center"
                    onHide={() => { if (!visible) return; setVisible(false) }}
                >
                    <div className="flex flex-col justify-center items-center space-y-4">
                        <img src={emailIcon} alt="Email verification" className="w-32 h-32 mb-6" />
                        ...
                        <p className="text-xs text-center mt-4">
                            ...
                            <Link className="text-blue-400 underline">Renvoyer</Link>
                        </p>
                    </div>
                </Dialog>
            </div>
