        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.8 }}>
            <main className="grid grid-cols-2 mx-40 space-x-28 justify-center items-center mt-28">
                <section className="mx-12">
                    ...
                    <motion.p className="text-center mt-8">Bienvenue à vous ! Veuillez vous connecter à votre compte</motion.p>

                    <div className="mt-12">
                        <Divider />
                        <p className="text-center text-xs mt-4">Vous n'avez pas encore de compte ? <Link to="" className="font-semibold text-white no-underline">Inscrivez-vous</Link></p>
                    </div>
                </section>
