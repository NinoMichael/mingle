...
const Register = () => {
    ...
    // Fonction pour afficher le pays sélectionné avec son drapeau
                ...
                <motion.form className="bg-blackAccent px-12 pt-8 pb-12 rounded shadow" variants={fadeInUp} transition={{ delay: 0.5 }}>
                    ...
                    <div className="p-inputgroup flex-1 mt-8">
                        <Dropdown
                            ...
                            valueTemplate={selectedCountryTemplate} // Afficher le pays sélectionné
                            className="w-10 font-poppins text-xs bg-transparent border-white"
