                    ...
                    <div className="bg-blackAccent rounded-3xl px-3">
                        <div className="p-inputgroup flex-1 ">
                            ...
                            <InputTextarea rows={1} autoResize value={inputMsg} onChange={(e) => setInputMsg(e.target.value)}
                                className="custom-input-search flex items-center mt-20 font-poppins bg-transparent indent-3 border border-none placeholder:text-white text-white text-xs"
