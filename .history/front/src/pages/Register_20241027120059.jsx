                ...
                <motion.form className="bg-blackAccent px-12 pt-8 pb-12 rounded shadow" variants={fadeInUp} transition={{ delay: 0.5 }}>
                    ...
                    <div className="p-inputgroup flex-1 mt-8">
                        <Dropdown
                            ...
                            showClear // Pour permettre à l'utilisateur de réinitialiser le champ
                        />
                        <FloatLabel>
                            <InputText
                                value={phoneNumber}
                        ...
                        {/* Afficher le drapeau sélectionné ici */}
                        {country && (
                            <img
                                alt={country.name}
                                src={`https://primefaces.org/cdn/primereact/images/flag/flag_placeholder.png`}
                                className={`ml-2 flag flag-${country.code.toLowerCase()}`}
                                style={{ width: '18px' }}
                            />
                        )}
                    </div>
