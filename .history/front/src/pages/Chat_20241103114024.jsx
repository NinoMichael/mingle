...
import MessageBlock from "../components/MessageBlock"  // Import du composant MessageBlock
            ...
            <motion.div initial="hidden" animate="visible" exit="hidden" transition={{ duration: 0.8 }} className="bg-blackPure w-[75vw] ms-[25vw]">
                {!msgContent && !selectedMessage ? (
                    ...
                    <>
                        ...
                        <div className="p-4 h-[calc(100vh-120px)] overflow-y-auto bg-blackPure">
                            {messages.map((msg, index) => (
                                <MessageBlock key={index} message={msg.text} isUser={msg.isUser} />
                            ))}
                        </div>
