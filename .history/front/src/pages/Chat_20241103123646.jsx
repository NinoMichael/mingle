...
const Chat = () => {
    ...
    const handleSubmitMessage = (message) => {
        // Vous pouvez ajouter un isUser comme vous le souhaitez
                    ...
                    <>
                        ...
                        <div className="py-4 px-6 h-[calc(100vh-120px)] overflow-y-auto bg-blackPure">
                            {messages.map((msg, index) => {
                                const isFirstInGroup = index === 0 || messages[index - 1].isUser !== msg.isUser;
                                return (
                                    <MessageBlock
                                        key={index}
                                        message={msg.text}
                                        isUser={msg.isUser}
                                        isFirstInGroup={isFirstInGroup} // Ajoutez cette ligne
                                    />
                                );
                            })}
                        </div>
