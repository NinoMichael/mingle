        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.8 }}>
            <div className="flex justify-between mt-8 mx-12">
                ...
                <Dialog
                    modal
                    visible={visible}
                    style={{ width: '50vw', backgroundColor: '#000' }} // Fond noir
                    onHide={() => { if (!visible) return; setVisible(false) }}
                    className="bg-blackAccent text-white font-poppins text-sm"
                >
                    <div className="flex flex-col justify-center items-center px-8 py-4">
                        <img src={emailIcon} alt="Email verification" className="w-64 h-52 mb-4" />

                        <p className="text-center w-96 text-white mb-4">
