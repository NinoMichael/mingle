...
import ChatForm from "../components/ChatForm"  // Import du nouveau composant ChatForm
...
const Chat = () => {
    ...
    const handleSubmitMessage = (message) => {
        ...
        // Ajouter le traitement de message ici, comme l'envoi au backend ou l'affichage dans la conversation
    }
