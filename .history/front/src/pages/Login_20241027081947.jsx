            ...
            <main className="grid grid-cols-2 mx-52 space-x-12 justify-center items-center mt-20">
                ...
                <form className="bg-blackAccent p-12 rounded shadow">
                    <div className="p-inputgroup flex-1">
                        ...
                        <FloatLabel>
                            <InputText value={identifiant} onChange={(e) => setIdentifiant(e.target.value)} className="font-poppins text-sm bg-transparent border-white text-white custom-input" />
                    ...
                    <div className="p-inputgroup flex-1 mt-6">
                        ...
                        <FloatLabel>
                            <Password value={mdp} onChange={(e) => setMdp(e.target.value)} className="font-poppins text-sm bg-transparent border-white text-white placeholder-white" />
