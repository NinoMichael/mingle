                ...
                <div className={selectedUser ? "flex flex-row space-x-3" : ""}>
                    ...
                    {selectedUser ? (
                        <div className="flex flex-col justify-center mt-6 shadow-lg">
                            ...
                            <Button label="Ajouter au contact" icon="pi pi-plus" className="font-poppins text-sm bg-blueSlate py-2 mt-4 mb-6 w-64 border border-none outline outline-none flex justify-center items-center mx-auto" />
