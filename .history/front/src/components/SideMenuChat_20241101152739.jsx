...
const SideMenuChat = () => {
                ...
                return (
                    <div>
                        {messagesHistory.map((messageHistory) => (
                            <div className="flex flex-row justify-start cursor-pointer hover:bg-gray-700 py-2 px-2 w-full space-x-4 mb-6" key={messageHistory.id}>
    ...
    return (
        <section className="fixed float-left -mt-1">
            <Menu model={chatItems} className="w-[25vw] pt-4 pb-2 px-5 bg-blackAccent font-poppins border border-none text-sm shadow-2xl h-[100vh]" />
        </section>
    )
}
