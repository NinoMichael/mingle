...
const SideMenuChat = ({ onSelectMessage }) => {
            ...
            template: () => {
                return (
                    <div className="flex flex-row justify-between space-x-12 mb-10 px-5">
                        ...
                        )} className="w-[18vw] bg-blackPure"></Sidebar>
    ...
    const sendMessage = (newMessage) => {
        const updatedMessages = messagesHistory.map((msg) => {
            if (msg.id === newMessage.id) {
                return {
                    ...msg,
                    message: newMessage.message, // Mettre à jour le message
                    timeout: "0 min", // Mettre à jour le délai pour le dernier message
                };
            }
            return msg;
        });
