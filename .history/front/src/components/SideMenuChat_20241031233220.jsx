                            ...
                            <div className="flex flex-row justify-start w-full space-x-4 mb-6" key={messageHistory.id}>
                                ...
                                <div className="flex flex-col -mt-6">
                                    <div className="flex flex-row justify-between">
                                        ...
                                        <span className="text-[0.75em] text-gray-300 mt-4">{messageHistory.timeout}</span>
                                    </div>

                                    <div className="flex flex-row justify-between space-x-28 -mt-3">
                                        <span className="text-xs text-white">{messageHistory.message}</span>
                                        <Badge value="2" className="font-poppins -mt-1 text-sm bg-blueSlate text-blackPure" />
                                    </div>
                                </div>
                            </div>
                        ))}
