...
import ContactDialog from '../components/ContactDialog';  // Importer le nouveau composant
...
const SideMenuChat = ({ onSelectMessage }) => {
                        ...
                        <div className="flex flex-row justify-start cursor-pointer hover:bg-blackPure hover:rounded py-2 px-2 w-full space-x-4 mb-2" key={messageHistory.id}
                            ...
                            <div className="flex flex-col flex-grow -mt-6">
                                ...
                                <div className="flex flex-row items-center">
                                    ...
                                    <Badge value="2" className="font-poppins text-sm bg-blueSlate text-blackPure ml-auto -mt-2" />
                                </div>
                            </div>
                        </div>
                    ))}
    ...
    return (
        <>
            ...
            <div className="bg-blackAccent w-[15vw] h-screen">
