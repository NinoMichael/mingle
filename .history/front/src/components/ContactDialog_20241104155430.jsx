                        ...
                        <div className="flex flex-col justify-center mt-6 shadow-lg">
                            <div>
                                ...
                                <div className="mt-3 text-center">
                                    ...
                                    <p className="-mt-4 font-poppins text-xs"><i className="pi pi-map-marker me-3 text-[0.75em]"></i>Habite à Soanierana</p>
                                </div>
                            </div>
                            ...
                            <div className="mt-4 mx-12">
                                ...
                                <div>
                                    <p className="text-sm text-white font-poppins"><i className="pi pi-phone me-3"></i>+ 261 32 45 678 90</p>
                                    <p className="text-sm text-white font-poppins"><i className="pi pi-envelope me-3"></i>tix@gmail.com</p>
                                </div>

                            </div>

                            <Button label="Ajouter au contact" icon="pi pi-plus" className="font-poppins text-sm bg-blueSlate py-2 mt-8 mb-16 w-64 border border-none outline outline-none flex justify-center items-center mx-auto" />
