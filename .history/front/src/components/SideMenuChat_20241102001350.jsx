                            ...
                            <>
                                ...
                                <div className="mt-4">
                                    {menuSideBar.map((menuItem) => (
                                        <div key={menuItem.id} className="mb-7 flex px-10">
                                            <span className="text-white text-sm font-poppins"><i className={`${menuItem.icon} me-6`}></i>{menuItem.menu}</span>
                                        </div>
                                    ))}
                                </div>

                                <span className="absolute bottom-4 text-center text-[0.6em] font-poppins text-white">Copyright 2024 - Tous droits réservés</span>
                            </>
