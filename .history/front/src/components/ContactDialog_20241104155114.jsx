                    ...
                    {selectedUser ? (
                        <div className="flex flex-col justify-center mt-6 shadow-lg">
                            ...
                            <div className="mt-4 mx-12">
                                ...
                                <div>
                                    <p className="text-sm text-white"><i className="pi pi-phone me-3"></i>+ 261 32 45 678 90</p>
                                    <p className="text-sm text-white"><i className="pi pi-envelope me-3"></i>tix@gmail.com</p>
                                </div>
