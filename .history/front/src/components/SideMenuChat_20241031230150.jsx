...
const SideMenuChat = () => {
    ...
    let chatItems = [
        ...
        },
        {
            template: () => {
                return (
                    <div className="flex flex-row justify-between space-x-8 mb-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex flex-row justify-between">
                                <span className = "text-xs t">Tena manao ah</span>
                                <Badge value="2" className="font-poppins text-sm bg-blueSlate"></Badge>
                            </div>
                        </div>
                    </div>
                )
