                            ...
                            <>
                                ...
                                <div className="mt-4">
                                    {menuSideBar.map((menuItem) => (
                                        <div key={menuItem.id} className="mb-7 flex justify-center items-center mx-auto">
                                            <span className="text-white text-sm font-poppins"><i className={`${menuItem.icon} me-3`}></i>{menuItem.menu}</span>
                                        </div>
                                    ))}
                                </div>
                            </>

                        )} className="w-[20vw] bg-blackPure">
