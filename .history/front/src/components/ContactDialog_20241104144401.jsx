        ...
        <Dialog
            ...
            content={({ hide }) => (
                <div className={selectedUser ? "flex flex-row space-x-3" : ""}>
                    <form className={selectedUser ? "w-[30vw]" : ""}>
                        ...
                        <div className={`absolute ${selectedUser ? "right-[25.5rem]" : "right-4"} bottom-4 cursor-pointer`} title="Sortir" onClick={(e) => hide(e)}>
                            <i className="text-white pi pi-sign-out hover:text-blueSlate"></i>
                        </div>
                    </form>

                    {selectedUser ? (
                        <div className="flex flex-col justify-center mx-auto mt-6 border-white border-s-4">
                            <div>
                                <Avatar label="JC" size="xlarge" shape="circle" className="ms-36 me-36 flex justify-center items-center" />
                                <div className="mt-3">
            ...
            className={`bg-blackAccent text-white ${selectedUser ? "w-[60vw]" : "w-[35vw]"} h-[70vh] p-4 rounded`}
        />
    )
}
