                ...
                return (
                    <div>
                        {messagesHistory.map((messageHistory) => (
                            <div className="flex flex-row justify-start cursor-pointer hover:bg-slate-900 hover:rounded py-2 px-2 w-full space-x-4 mb-2" key={messageHistory.id}>
                                ...
                                <div className="flex flex-col flex-grow -mt-6">
                                    ...
                                    <div className="flex flex-row items-center me-3">
                                        <span className="text-xs text-white flex-grow -mt-4 me-12">{messageHistory.message}</span>
